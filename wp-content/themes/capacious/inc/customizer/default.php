...
if ( !function_exists('capacious_get_default_theme_options' ) ) :
    ...
    function capacious_get_default_theme_options()
    {
        ...
        $default['capacious_top_header_phone_no'] = esc_html__('+ 1 (1800) 459 123 7', 'capacious');
        $default['capacious_email_icon'] = 'fa-envelope-o';
        $default['capacious_top_header_email'] = esc_html__('example@gmail.com', 'capacious');
        ...
        $default['capacious_copyright_text_option'] = wp_kses_post('Copyright © capacious 2017. All rights reserved.','capacious');
        ...
        $default['capacious_quote_get_a_quate_link'] = esc_html__('www.example.com', 'capacious');
        $default['capacious_homepage_about_option'] = 0; 
