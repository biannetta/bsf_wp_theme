...
function capacious_customize_preview_js() {
	wp_enqueue_script( 'capacious_customizer', get_template_directory_uri() . '/assets/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
...
function capacious_customize_backend_scripts() {
    ...
    wp_enqueue_style( 'capacious_font-awesome', get_template_directory_uri() . '/inc/customizer/css/font-awesome.css', array(), '7.1.0' );  

    wp_enqueue_script( 'capacious_admin_customizer', get_template_directory_uri() . '/inc/customizer/js/admin-scripts.js', array( 'jquery', 'customize-controls' ), '20160714', true );
