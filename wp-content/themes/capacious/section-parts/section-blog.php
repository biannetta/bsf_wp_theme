        ...
        <div class="container">
         ...
         ?> 
          <div class="view-all text-right">
              <a href="<?php echo esc_attr("category/". $slug ); ?>" class="btn btn-theme hvr-sweep-to-right"><?php echo esc_html ($view_all_text ); ?></a>
          </div>
       <?php } ?>
                    ...
                    <div class="col-md-4 col-lg-4">
                      <div class="section-blog-box wow fadeInUp">
                        <?php 
                         ...
                         ?>
                             <img src="<?php  echo esc_url($image_url[0]) ?>" class="img-responsive" alt="<?php the_title(); ?>">
                         <?php } ?>
