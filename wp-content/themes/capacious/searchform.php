<div class="search-block">
    <form action="<?php echo esc_url( home_url() )?>" class="searchform" id="searchform" method="get" role="search">
        <div>
            ...
            <input type="text" placeholder='<?php echo esc_html($capacious_placeholder_option) ;?>'  class="menu-search" id="menu-search" name="s" value="<?php echo esc_attr( get_search_query() );?>">
